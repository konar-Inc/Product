...
namespace ChessEngine
{
    ...
    {
        public static int EvaluatePositionScore(CandidatePosition candidate, CheckerBoard checkerBoard, PointState targetState)
        {
            int score = 0;
        ...
        private static int EvaluateFirstLevelPathScore(Path path, CheckerBoard checkerBoard, Dictionary<string, CandidatePosition> nextStepCandidateScores)
        {
            int score = 0;
            ...
            else 
            {
                ...
                foreach (var candidatePosition in nextStepCandidatePositions.Values)
                {
                    ...
                    int candidateScore = EvaluateSecondLevelPathScore(ExtendedPath, checkerBoard);
        ...
        private static int EvaluateSecondLevelPathScore(Path path, CheckerBoard checkerBoard)
        {
            int score = 0;
